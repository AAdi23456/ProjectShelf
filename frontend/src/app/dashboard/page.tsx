...
export default function DashboardPage() {
  ...
  const handleUpgrade = async () => {
    try {
      ...
      toast.success('Successfully upgraded to Creator account!');
    } catch (error) {
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            {user?.role === 'CREATOR'
              ...
              : 'Upgrade to a creator account to create and manage projects'}
          </p>
        </div>
            ...
            <Card className="bg-muted">
              <CardContent className="flex flex-col sm:flex-row justify-between items-center p-6">
                <div className="mb-4 sm:mb-0">
                  ...
                  <p className="text-muted-foreground">Create and showcase your portfolio projects</p>
                </div>
